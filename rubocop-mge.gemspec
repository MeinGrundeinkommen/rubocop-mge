...
require_relative 'lib/rubocop/mge/version'
...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = 'https://github.com/MeinGrundeinkommen/rubocop-mge'
  spec.license       = 'MIT'
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/MeinGrundeinkommen/rubocop-mge'
  ...
  spec.add_runtime_dependency 'rubocop', ' ~> 1.2'
end
